...
var startWorkflow = function(region, domain, workflowName, workflowVersion, taskList, input) {
  AWS.config.update({
...
startWorkflow("us-west-2", "oam-tiler-test", "tiler-test-2", "1.0", "tiler-test-task-list", input);
